...
### 3.5. NHS Pharmacy Contraception Service (PCS)
...
### 3.6. Seasonal Influenza Vaccination Service
...
### 3.7. Statistics on Public Health 
...
### 3.9. Exemption category backfilling
...
#### 3.9.1. Department for Work and Pensions (DWP) benefits and RTEC
...
### 3.10. Estimated prescription charges

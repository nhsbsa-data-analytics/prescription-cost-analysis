extract_region_data <- function(con, year_type = c("financial", "calendar"), year = "year") {
  ...
  if (year_type == "financial") {
    ...
    raw_data <- fact_db |>
      ...
      dplyr::select("MONTH_TYPE", "YEAR_DESC", "REGION_NAME", "REGION_CODE", 
                    ...
                    "ITEM_CALC_PAY_QTY") |>
      dplyr::group_by(MONTH_TYPE, YEAR_DESC, REGION_NAME, REGION_CODE,  DISP_PRESEN_BNF, DISP_PRESEN_BNF_DESCR, DISP_PRESEN_SNOMED_CODE,
      ...
      dplyr::arrange(MONTH_TYPE, YEAR_DESC, REGION_NAME, DISP_PRESEN_BNF, DISP_SUPPLIER_NAME) |>
      collect()

pca_bottom_total_cost_change <- function(con) {
  #extract raw data
  ...
  table <- data |>
    ...
    dplyr::mutate(
      ...
      dplyr::across(
        ...
        .fns = ~!!unit_cost_col - replace_na(.x, 0),
        .names = "{.col}_DIFF"
      ),
      dplyr::across(

...
### `r paste0("Figure ",8,": Dispensed items per capita by Sustainability and Transformation Partnership (ICB) ",year_tidy)`
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "The mean cost of items dispensed per capita in England was £178 in 2021/22.", width = "100%")` 
::: 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "NHS Cambridgeshire and Peterborough Integrated Care Board had the highest cost per capita of £379.", width = "100%")` 
:::
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "NHS South East London Integrated Care BoardP had the lowest of £119.", width = "100%")` 
:::
::::

...
### `r paste0("Figure 6: Sankey chart to show the flow of prescribing volumes England ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))`

```{r presc_sankey, out.width = "100%", out.height=600}
...
```
`r get_download_button(title = "Download chart data", data = figure_9_data, filename = "figure_10")`

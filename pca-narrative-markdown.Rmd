...
knitr::kable(figure_4_table, align = "llr")
...
### `r paste0("Figure 5: Distribution of items dispensed in England amongst BNF chapters ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))`

...
:::{.col-md-12} 
`r infoBox_border(header = "Changes to these statistics", text = paste0("For this release, we have included SNOMED level data at a national level in the supporting tables. We have also included information on the presentations with the largest decreases in unit costs and total costs. We are interested in any feedback about the publication or these changes, which you can send by using our ", htmltools::HTML(paste("<a href='",config$stats_survey_link,"'>Official Statistics feedback survey</a>")),"."), width = "100%")` 
::: 
::::
...
In 2022/23, the chapter on the Cardiovascular System in the BNF had the highest number of prescription items dispensed in England, with a total of 340 million items. This accounted for 29% of all items dispensed. The Central Nervous System chapter followed with 230 million items, representing 19% of items. The Endocrine System chapter had 130 million items, accounting for 11% of items.
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "Generic items made up 85% of the total items prescribed in 2022/23.", width = "100%")` 
::: 
:::{.col-md-4} 
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "In 2022/23 66 million of the 950 million items prescribed generically were dispensed as a proprietory", width = "100%")` 
::: 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "In 2022/23 7% of items prescribed generically were dispensed as a propietory.", width = "100%")` 
:::
::::
...
::: 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "Three of the top ten chemical substances by costs are anticoagulants used to help prevent blood clots.", width = "100%")` 
:::
:::{.col-md-4} 
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-12} 
`r infoBox_no_border(header = "", text = "Between 2021/22 and 2022/23 the total costs of Apixaban 5mg tablets increased by £280 million, the highest absolute change of all presentations. A generic version of Apixiban was made available to suppliers in May 2022.", width = "100%")` 
::: 
::::
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-12} 
`r infoBox_no_border(header = "", text = "Between 2021/22 and 2022/23 the total costs of Eliquis 5mg tablets decreased by £260 million, the highest absolute decrease of all presentations. Eliquis is a propietory version of Apixiban which a generic version of was made available to suppliers in May 2022.", width = "100%")` 
::: 
::::
...
This publication has historically been released in the month of April. To accommodate the inclusion of financial year information these statistics will now be released in June, after March data becomes available each year. Calendar year data is currently released at the same time as financial year information. We're seeking users' views on publishing calendar year data earlier in the year.

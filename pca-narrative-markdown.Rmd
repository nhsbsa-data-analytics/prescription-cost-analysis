...
::: 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "0.9% increase in costs from 2020/21 to 2021/22.", width = "100%")` 
:::
:::{.col-md-4} 
...
In England, the cost of prescription items in 2021/22 was £9.7 billion, which is 0.9% more than the previous year's cost of £9.6 billion. Compared to 2014/15, the cost has increased by 8.4% or £746 million. This marks the third year in a row where the cost of items dispensed has increased, after seeing a decrease in the previous three years from 2015/16 to 2018/19.
...
::: 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "2.6% increase in items from 2020/21 to 2021/22.", width = "100%")` 
:::
:::{.col-md-4} 
...
In England, there were 1.14 billion items dispensed in 2021/22, which is 2.6% more than the previous year's 1.11 billion items. Compared to 2014/15, the number of items has increased by 6.4%.
...
In 2021/22, the chapter on the Cardiovascular System in the BNF had the highest number of prescription items dispensed in England, with a total of 334 million items, accounting for 29.3% of all items dispensed. The Central Nevous System chapter followed with 224 million items, representiing 19.6% of items. The Endocrine System chapter had 119 million items, accounting for 10.5% of items.
...
In 2021/22, the BNF chapter on the Cardiovascular System had the highest costs, totalling £1.62 billion, which was equal to 16.7% of all costs. The Endocrine System chapter followed with costs of £1.56 billion, representing 16.1% of costs. The Cental Nervous System chapter had costs of £1.55 billion, 16.0% of the total costs.

The top three BNF chapters by both costs and items were the same in 2021/22. However, there was a smaller difference in costs between chapters. The top chapter had only 4.32% higher costs than the third placed chapter, despite have 64.4% more items.
...
In 2021/22, 84.3% of prescription items were prescribed generically, which is slightly lower then the previous year and the highest rate which was recorded in 2014/15. However, the rate of generic prescribing has remained consistent over the period. There has been a 1.1 percentage point variation between 2014/15 and 2021/22. Note that these figures exclude preparation class 4 products - appliances.

Regarding the cost of reimbursement, in 2021/22, generic prescribing accounted for 60.6% of the total cost. This is the lowest rate in the reporting period. This is a decrease of 2.50 percentage points from the previous year. The proportion of costs attributed to generic prescribing has shown greater variation, with a range of 7.40 percentage points over the period. The proportion of costs for generic prescrbing had increased for three consecutive years from 2018/19 to 2020/21.
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "Atorvastatin was the most dispensed chemical susbtance with 53.4 million items.", width = "100%")` 
::: 
:::{.col-md-6} 
...
[Atorvastatin](https://www.nhs.uk/medicines/atorvastatin/) was the most dispensed chemical substance in 2021/22, with 53.4 million items. This medication is a type of statin that is commonly used to lower cholesterol and help prevent heart disease. Four of the top ten dispensed chemical substances belong to BNF chapter 02 - Cardiovascular System. These susstances are Atorvastatin, Amlodipine, Ramipril, and Bisoprolol fumarate.
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "Apixiban had the highest costs of £401 million.", width = "100%")` 
::: 
:::{.col-md-6} 
...
:::
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "Surrey Heartlands Health and Care Partnership STP had the lowest with 13.0.", width = "100%")` 
:::
::::
...
It is worth noting that Cambridgeshire and Peterborough STP offer specialist stoma care, 33.6% of their total costs of £317 million in 2021/22 were in BNF chapter 23 (Stoma Appliances).
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-12} 
`r infoBox_no_border(header = "", text = "Between 2020/21 and 2021/22 the total costs of FreeStyle Libre 2 Sensor kits increased by £69.8 million, the highest absolute change of all presentations. The FreeStyle Libre 2 Sensor was added to part IX of the drug tariff in November 2020.", width = "100%")` 
::: 
::::

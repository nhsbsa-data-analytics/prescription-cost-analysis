...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-4} 
`r infoBox_no_border(header = "BNF chapter 02 - Cardiovascular System accounted for 29% of all items dispensed.", text = "", width = "100%")` 
::: 
:::{.col-md-4} 
`r infoBox_no_border(header = "BNF chapter 04 - Central Nervous System accounted for 20% of all items dispensed.", text = "", width = "100%")` 
:::
:::{.col-md-4} 

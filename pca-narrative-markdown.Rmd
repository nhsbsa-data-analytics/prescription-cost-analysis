...
:::{.col-md-12} 
`r infoBox_border(header = "Feedback", text = paste0("We are interested in any feedback about the publication or these changes, which you can send by using our ", htmltools::HTML(paste("<a href='",config$stats_survey_link,"'>Official Statistics feedback survey</a>")),"."), width = "100%")` 
::: 
::::
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = htmltools::HTML("<b>In 2022/23 1.18 billion prescription items were dispensed in the community in England at a cost of £10.4billion.</b>"), width = "100%")` 
::: 
:::{.col-md-6} 
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "Prescription items dispensed in the community in England in 2022/23 cost £10.4 billion.", width = "100%")` 
::: 
:::{.col-md-4} 
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "In 2022/23 1.18 billion items were dispensed in the community in England.", width = "100%")` 
::: 
:::{.col-md-4} 
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "IBNF chapter 02 - Cardiovascular System accounted for 29% of all items dispensed in 2022/23.", width = "100%")` 
::: 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "BNF chapter 04 - Central Nervous System accounted for 19% of all items dispensed in 2022/23.", width = "100%")` 
:::
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "BNF chapter 06 - Endocrine System accounted for 11% of all items dispensed in 2022/23.", width = "100%")` 
:::
::::
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "BNF chapter 06 - Endocrine System accounted for 17% of total costs in 2022/23.", width = "100%")` 
::: 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "BNF chapter 02 - Cardiovascular System accounted for 16% of total costs in 2022/23.", width = "100%")`
:::
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "BNF chapter 04 - Central Nervous System accounted for 15% of total costs in 2022/23.", width = "100%")` 
:::
::::
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-12} 
`r infoBox_border(header = "", text = "Generically prescribed items are those with a prescribed preparation class of 1, 2, or 5.<br><br>Generically prescribed and dispensed items are those with a prescribed preparation class of 1, 2, or 5 and dispensed as items with a class of 1 or 5.<br><br>Generically prescribed/proprietary dispensed items are those with a prescribed preparation class of 1, 2 or 5 and dispensed as items with a class of 2 or 3.<br><br>Proprietary prescribed and dispensed items are those with a prescribed preparation class of 3 and dispensed as items with a class of 3.<br><br>Dressings and appliances are items which were dispensed as a preparation class of 4<br><br>It is possible that drugs prescribed generically don't have any actual generics available for example those in Drug Tariff category C.", width = "100%")` 
::: 
::::

::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "In 2022/23 66 million of the 950 million items prescribed generically were dispensed as a proprietary", width = "100%")` 
::: 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "In 2022/23 7% of items prescribed generically were dispensed as a propietary.", width = "100%")` 
:::
::::
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "Atorvastatin was the most dispensed chemical susbtance in 2022/23 with 59 million items.", width = "100%")` 
::: 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "Four of the top ten chemical substances by items in 2022/23 belong to BNF chapter 02 - Cardiovascular System.", width = "100%")` 
:::
::::
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "Apixiban had the highest costs in 2022/23 of £430 million.", width = "100%")` 
::: 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "Three of the top ten chemical substances by costs in 2022/23 are anticoagulants used to help prevent blood clots.", width = "100%")` 
:::
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "Two of the top ten chemical substances by costs in 2022/23 are used to treat respiratory illnesses.", width = "100%")` 
:::
::::
...
:::
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "NHS South East London Integrated Care Board had the lowest of £123.", width = "100%")` 
:::
::::
...
Aripiprazole 5mg tablets, Aripiprazole 10mg tablets and Aripiprazole 15mg tablets were all granted price concession in May 2022.
...
Between 2021/22 and 2022/23 the total costs of Eliquis 5mg tablets decreased by £260 million, the highest absolute decrease of all presentations. Eliquis is a proprietary version of Apixiban which a generic version of was made available to suppliers in May 2022.
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "There were 20 items per head of population dispensed in England in 2021/22.", width = "100%")` 
::: 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "Scotland who had the fewest items dispensed per capita of 19.", width = "100%")` 
::: 
:::{.col-md-4} 
`r infoBox_no_border(header = "", text = "There were 26 items per head of population dispensed in Wales in 2021/22.", width = "100%")` 
::: 
::::
...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "England had the lowest prescription item cost per head of population in 2021/22 of £171.", width = "100%")` 
::: 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "Northern Ireland had the lowest prescription item cost per head of population in 2021/22 of £247.", width = "100%")` 
::: 
::::
...
This publication has historically been released in the month of April. To accommodate the inclusion of financial year information these statistics will now be released in June, after March data becomes available each year. Calendar year data is released in June in line with the publication, calendar year data is published when December data available, usually in February on the [NHSBSA Open Data Portal](https://opendata.nhsbsa.net/) (ODP).

### 4.5. Price concessions {.toc-ignore}

When community pharmacies cannot source a drug at or below the reimbursement price as set out in the Drug Tariff, the Department of Health and Social Care (DHSC) can introduce a [price concession](https://cpe.org.uk/funding-and-reimbursement/reimbursement/price-concessions/) at the request of Community Pharmacy England. A price concession can be requested for any drugs listed in Part VIIIA, Part VIIIB and Part VIIID of the Drug Tariff. For any drugs granted price concessions, contractors are automatically reimbursed at the new prices for that month.

...
### `r paste0("Figure 5: Percentage of items prescribed generically and percentage costs excluding appliances England ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))`

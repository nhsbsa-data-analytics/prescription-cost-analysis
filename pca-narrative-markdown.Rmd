...
### 2.1. Cost and number of prescription items dispensed in England {.tabset}

#### Chart

##### Figure 1: The cost of prescription items dispensed in England has been increasing since 2018/19

###### `r paste0("Cost of prescription items dispensed in England 2014/15 to ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))`
...
In England, the cost of prescription items in 2022/23 was £10.4 billion, which is 8% more than the previous year's cost of £9.69 billion. Compared to 2014/15, the cost has increased by 17% or £1.48 billion. This marks the fourth year in a row where the cost of items dispensed has increased, after seeing a decrease in the previous 3 years from 2015/16 to 2018/19.
...
###### `r paste0("Number of prescription items dispensed in England 2014/15 to ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))`
...
### 2.2. Cost and number of prescription items dispensed in England amongst BNF chapters {.tabset}

#### Chart

##### Figure 3: In 2022/23 BNF chapter 06 - Endocrine System had the highest costs
...
##### Table 3: In 2022/23 BNF chapter 06 - Endocrine System had the highest costs
...
##### Figure 4: BNF chapter 02 - Cardiovascular System has shown the greatest percentage increase in costs from 2014/15 to 2022/23
...
##### Table 4: BNF chapter 02 - Cardiovascular System has shown the greatest percentage increase in costs from 2014/15 to 2022/23
...
***** PLACEHOLDER --- INDEX CHART NARRATIVE AND INFOBOXES *****

### {- .tabset}

#### Chart

##### Figure 5: In 2022/23 BNF chapter 02 - Cardiovascular System	 had the highest number of items
...
##### Table 5: In 2022/23 BNF chapter 02 - Cardiovascular System	 had the highest number of items

```{r bnf_chapters_items_table, out.width = "100%"}
knitr::kable(figure_5_table, align = "lrr")
...
##### Figure 6: BNF chapter 06 - Endocrine System has shown the greatest percentage increase in items from 2014/15 to 2022/23
...
##### Table 6: BNF chapter 06 - Endocrine System has shown the greatest percentage increase in items from 2014/15 to 2022/23
...
### `r paste0("Percentage of items prescribed generically and percentage costs excluding appliances England ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))` {- .tabset}

#### Chart

##### Figure 7: Between 2014/15 and 2022/23 the percentage of items precribed generically has remained constant 
...
##### Table 7: Between 2014/15 and 2022/23 the percentage of items precribed generically has remained constant 
...
### `r paste0("Flow of prescribing and dispensing volumes England ")` {- .tabset}

#### Chart

##### Figure 8: In 2022/23 the majority of items were both prescribed and dispensed generically
...
##### Table 8: In 2022/23 the majority of items were both prescribed and dispensed generically
...
### `r paste0("The 10 most dispensed chemical substances by costs and items in ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))` {- .tabset}
...
The top ten chemical substances by cost included 2 drugs that are commonly used to treat respiratory illnesses. These are Beclometasone dipropionate and Budesonide.
...
### `r paste0("Figure ",11,": Cost per capita (£) by Integrated Care Board (ICB) ",year_tidy)`
...
### `r paste0("Figure ",12,": Dispensed items per capita by Integrated Care Board (ICB) ",year_tidy)`
...
### `r paste0("Figure 13: Top 10 presentations by percentage increase in unit cost ",paste0(substr(max_data_fy_minus_1,1,5), substr(max_data_fy_minus_1, 8, 9)), " to ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))`
...
### `r paste0("Figure 14: Top 10 presentations by percentage decrease in unit cost ",paste0(substr(max_data_fy_minus_1,1,5), substr(max_data_fy_minus_1, 8, 9)), " to ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))`
...
### `r paste0("Figure 15: Top 10 presentations by increase in total cost ", paste0(substr(max_data_fy_minus_1,1,5), substr(max_data_fy_minus_1, 8, 9)), " to ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))`
...
### `r paste0("Figure 16: Top 10 presentations by decrease in total cost ", paste0(substr(max_data_fy_minus_1,1,5), substr(max_data_fy_minus_1, 8, 9)), " to ", paste0(substr(max_data_fy,1,5), substr(max_data_fy, 8, 9)))`
...
### `r paste0("Figure 17: Cost per capita for the UK nations ", max_data_fy_minus_1)`
...
### `r paste0("Figure 18: Items per capita for the UK nations ", max_data_fy_minus_1)`
